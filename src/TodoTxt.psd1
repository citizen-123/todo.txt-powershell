@{
    ...
    PrivateData       = @{
        PSData = @{
            ...
            ReleaseNotes = 'v1.1.0: due/threshold/recurrence date tags (agenda action, TODOTXT_HIDE_FUTURE_TASKS, TODOTXT_RECURRENCE), tab completion (Register-TodoArgumentCompleter), and restored todo.sh sort parity for completed tasks. See CHANGELOG.md.'
        }
    }
}
